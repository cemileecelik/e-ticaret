        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  " value="<?php echo $uruncek['urun_video']; ?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                  ...
                  " value="<?php echo $uruncek['urun_keyword']; ?>" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
                  ...
                  " value="<?php echo $uruncek['urun_stok']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                                </div>
                            </div>
