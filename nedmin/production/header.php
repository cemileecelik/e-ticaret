...
/*1.yöntem izinsiz girişler için

if(!isset($_SESSION['kullanici_mail'])) {

}
!- ünlem kullanıcı mail dolu değilse anlamı katar.
*/

//Hepsinde ortak olarak header.php dosyasını kullandığımız için bir fonksiyon yazıp checkDurum() olarak diğerlerine
