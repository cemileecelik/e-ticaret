          ...
          <div class="x_content">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="menu_ad" disabled="" value="<?php echo $_SERVER['HTTP_HOST']?>/sayfa-<?php echo seo($menucek['menu_ad']); ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  " value="<?php echo $menucek['menu_sira']; ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
